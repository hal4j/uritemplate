...
/**
 * @see <a href="https://www.rfc-editor.org/rfc/rfc6570#section-3.2.8">3.2.8.  Form-Style Query Expansion: <strong>{?var}</strong></a>
 */
public class FormStyleQueryExpansionTest {
    ...
    public void shouldPerformFormStyleQueryExpansionCorrectly(String template, String expectation) {
