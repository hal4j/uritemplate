...
public class URITemplateParserTest {
    ...
    public void shouldThrowNPEOnNull() {
        assertThrows(NullPointerException.class, () -> {
            URITemplateParser.parseAndExpand(null, SINGLE);
        });
    }
    ...
    public void shouldReturnEmptyStringAsIs() {
        String uri = "";
        String result = URITemplateParser.parseAndExpand(uri, SINGLE);
    ...
    public void shouldIgnoreUnusedParametersInArray() {
        ...
        String result = URITemplateParser.parseAndExpand(uri, asList(1, 2), "another");
        assertEquals(expected, result);
    }
    ...
    public void shouldOmitParameterWithEmptyListOfValuesPassedInArray() {
        String uri = "http://www.example.com{?p1,p2}";
        String expected = "http://www.example.com?p2=v2,v3";
        String result = URITemplateParser.parseAndExpand(uri, emptyList(), asList("v2", "v3"));
        assertEquals(expected, result);
    }
    ...
    public void shouldConcatenatePathElementsWithCommaWithoutModifiers() {
        ...
        String result = URITemplateParser.parseAndExpand(uri, singletonMap("p1", asList("v1", "v2")));
        assertEquals(expected, result);
    }
    ...
    public void shouldPreservePathSeparatorWhenTwoPathSegmentsAreTemplates() {
        ...
        String result = URITemplateParser.parseAndExpand(uri,
    ...
    public void shouldSubstituteHostname() {
        ...
        String result = URITemplateParser.parseAndExpand(uri, "https", "www.example.com","api", asList(1, 2));
        assertEquals(expected, result);
    }
    ...
    public void shouldSubstituteDomainName() {
        ...
        String result = URITemplateParser.parseAndExpand(uri, singletonMap("dom", asList("example", "com")));
        assertEquals(expected, result);
    }
    ...
    public void shouldExpandFragment() {
        ...
        String result = URITemplateParser.parseAndExpand(uri, LIST);
        assertEquals(expected, result);
    }
    ...
    public void shouldExpandByNameMultipleTimes() {
        ...
        String result = URITemplateParser.parseAndExpand(uri, singletonMap("who", "fred"));
        assertEquals(expected, result);
    }
    ...
    public void shouldTruncateValue() {
        ...
        String result = URITemplateParser.parseAndExpand(uri, singletonMap("var", "value"));
        assertEquals(expected, result);
    }
    ...
    public void shouldCorrectlyTruncateSpecialCharacter() {
        String uri = "{semi:2}";
        String expected = "%3B";
        String result = URITemplateParser.parseAndExpand(uri, singletonMap("semi", ";"));
        assertEquals(expected, result);
    }
    ...
    public void shouldExpandPreEncodedValueCorrectly() {
        ...
        String result = URITemplateParser.parseAndExpand(uri, singletonMap("base", "https://www.example.com"));
        assertEquals(expected, result);
    }
